      ...
      <div className='flex mt-12 w-full flex-wrap items-center gap-20 justify-center '>
        <div className='flex flex-wrap items-center lg:justify-start justify-center lg:gap-32 gap-10 w-full'>
          <div className='flex flex-col h-24  items-center justify-between '>
            <Image width={0} height={0} className='h-auto w-10' src="/assets/techstack/backend/back1.svg" alt="" />
            <p className='text-sm text-gray-500'>React</p>
          </div>
          <div className='flex flex-col h-24  items-center justify-between '>
            <Image width={0} height={0} className='h-auto w-10' src="/assets/techstack/backend/back2.svg" alt="" />
            <p className='text-sm text-gray-500'>Flutter</p>
          </div>
          <div className='flex flex-col h-24  items-center justify-between '>
            <Image width={0} height={0} className='h-auto w-10' src="/assets/techstack/backend/back3.svg" alt="" />
            <p className='text-sm text-gray-500'>Flutter</p>
          </div>
          <div className='flex flex-col h-24  items-center justify-between '>
            <Image width={0} height={0} className='h-auto w-10' src="/assets/techstack/backend/back4.svg" alt="" />
            <p className='text-sm text-gray-500'>Flutter</p>
          </div>
          <div className='flex flex-col h-24  items-center justify-between '>
            <Image width={0} height={0} className='h-auto w-10' src="/assets/techstack/backend/back5.svg" alt="" />
            <p className='text-sm text-gray-500'>Flutter</p>
          </div>
