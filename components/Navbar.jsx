  ...
  return (
    <div className='w-full z-50 navbar flex items-center relative justify-between text-white p-10'>
      ...
      <nav className='hidden lg:block' >
        ...
        <Link href={'/'} onClick={()=>{setVisible(!visible)}}>Services <i className="ri-arrow-down-s-line"></i></Link>
      ...
      <Link href={'/'} onClick={()=>{setVisible3(!visible3)}}>Services <i className="ri-arrow-down-s-line"></i></Link>

      <i onClick={()=>{setVisible2(!visible2)}} className="ri-menu-4-line text-3xl"></i>
      </div>
      <div className={`absolute laptop w-[95%]  p-5 navbar gap-5 ${visible ? 'flex' : 'hidden'} flex-wrap items-start justify-center top-20 `}>
      ...
      <div className={`absolute w-[70%] right-4 top-20 navbar ${visible2 ? 'flex' : 'hidden'}  flex-col items-center justify-center gap-4`}>
      <nav >
        <ul className='gap-8 p-6 rounded-xl glow flex flex-col text-sm font-medium items-center justify-center'>
        <Link className='underline' href={'/'}>Case Studies</Link>
        <Link className='underline' href={'/blogs'}>Blogs</Link>
        <Link className='underline' href={'/'}>About Us</Link>
        <Link className='underline' href={'/'}>Contact</Link>
        </ul>
      </nav>
      </div>

      <div className={`absolute mobile w-full   navbar gap-2 p-5 ${visible3 ? 'flex' : 'hidden'} flex-wrap items-start justify-center left-0 top-20 `}>
          <div className='rounded-xl w-full border-2 p-4 relative border-gray-500 flex items-center justify-start'>
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            <div>

            <h1 className='text-md font-semibold text-white'>Jamstack Development</h1>
          ...
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            ...
            <h1 className='text-md font-semibold text-white'>MVP & POC Development</h1>
          ...
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            ...
            <h1 className='text-md font-semibold text-white'>Headless Commerce</h1>
          ...
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            ...
            <h1 className='text-md font-semibold text-white'>UI/UX Designing</h1>
          ...
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            ...
            <h1 className='text-md font-semibold text-white'>Custom Software Development</h1>
          ...
          <i className="ri-arrow-right-line absolute text-xl top-4 right-5"></i>
            ...
            <h1 className='text-md font-semibold text-white'>CTO as a Service</h1>
