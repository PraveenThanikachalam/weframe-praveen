  ...
  return (
    <div className='lg:w-[80%] w-[85%] borderGrd border border-gray-400 rounded-xl flex flex-col-reverse lg:flex-row lg:h-[75vh]'>
      <div className='lg:w-[40%] w-full flex lg:p-10 p-5 flex-col items-center justify-center'>
        <h1 className='lg:text-2xl text-xl font-bold text-white'>Freemium Blog Platform for Entrepreneurs</h1>
        ...
        <div className='flex mt-5 items-center justify-between w-full'>
            <div className='flex gap-3 text-white'>
                <div className='w-12 h-12 rounded-full border flex items-center justify-center border-white'><i className="ri-arrow-left-line"></i></div>
                <div className='w-12 h-12 rounded-full border flex items-center justify-center border-white'><i className="ri-arrow-right-line"></i></div>
            </div>
