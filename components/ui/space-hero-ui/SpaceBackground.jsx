...
import SpotLight2 from '@/public/for-space-hero/SpotLight2.png';
    ...
    <div
      ...
      style={{
        background: `radial-gradient(
          ...
          rgba(1, 11, 12, 1) 0%, /* Fully opaque at the top */
          rgba(1, 11, 12, 1) 10%, /* Fully opaque at the top */
          rgba(1, 11, 12, 1) 20%, /* Slightly transparent */
          rgba(1, 11, 12, 0.3) 50%, /* More transparent */
          rgba(1, 11, 12, 0.1) 70%, /* Even more transparent */
          rgba(1, 11, 12, 0) 80%,
          rgba(1, 11, 12, 0) 90%, 
