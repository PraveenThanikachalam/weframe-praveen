  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="relative w-screen md:w-[95vw] flex justify-center items-center">
        ...
        <div className=" w-52 h-52 md:w-[500px] md:h-[500px] block z-0 -scale-y-100 rotate-90 bottomLightBg overflow-x-hidden rounded-tr-full"></div>
        <div className=" w-52 h-52 md:w-[500px] md:h-[500px] block z-0 rotate-90 bottomLightBg overflow-x-hidden rounded-tr-full"></div>
      ...
      <div className="w-52 md:w-[500px] h-[1px] blur-[1px] bg-[#30eeff] absolute rounded-full"></div>
    </div>
  );
}
