export default function BackLightEffect() {
  return (
    <div className="relative w-[95vw] flex justify-center items-center">
      ...
      <div className=" w-52 h-52 md:w-[500px] md:h-[500px] block -scale-y-100 rotate-90 bottomLightBg overflow-x-hidden"></div>
      <div className=" w-52 h-52 md:w-[500px] md:h-[500px] block rotate-90 bottomLightBg overflow-x-hidden"></div>
