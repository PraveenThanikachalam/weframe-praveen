    ...
    <>
        ...
        <div className="w-[80%] flex flex-col lg:flex-row text-center lg:text-left items-center justify-between">
          ...
          <div className="flex gap-3 mt-4 lg:mt-0 text-white ">
            <div onClick={() => swiperRef.current.slidePrev()} className="w-12 h-12 hover:bg-white hover:text-black cursor-pointer rounded-full  flex items-center justify-center border border-white">
              <i className="ri-arrow-left-line  "></i>{' '}
            </div>
            <div onClick={() => swiperRef.current.slideNext()} className="w-12 h-12 hover:bg-white hover:text-black cursor-pointer rounded-full  flex items-center justify-center border border-white">
