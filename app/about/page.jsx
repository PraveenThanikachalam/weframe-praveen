  ...
  return (
    <section className="flex flex-col justify-center items-center w-full max-w-screen-xl mx-auto px-3">
            ...
            <div className="flex glow gap-12">
              {
                data?.stats.map((stat,index)=>{
                  return   <div key={index} className="flex flex-col items-center gap-1 justify-center">
      ...
      <div className="lg:my-56 mt-28">
        <ProgressFlow title={data?.section1_heading} arr={data?.section1_points} />
      </div>
      <div className="w-full">
        <CultureComponent title={data?.section2_heading} arr={data?.section2_images} />
      </div>
